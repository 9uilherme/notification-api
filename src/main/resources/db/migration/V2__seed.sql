insert into profile(id, current, name, user_id) values (nextval('profile_sequence'), true, 'ONLINE', 'iorran');
...
insert into profile(id, current, name, user_id) values (nextval('profile_sequence'), true, 'ONLINE', 'francisca');
insert into channel_config values (nextval('hibernate_sequence'), 'WHATSAPP');
insert into whatsapp_config (id, user_id, number)
...
insert into profile(id, current, name, user_id) values (nextval('profile_sequence'), false, 'AWAY', 'iorran');
insert into profile(id, current, name, user_id) values (nextval('profile_sequence'), true, 'AWAY', 'francisca');
